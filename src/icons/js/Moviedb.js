...
const SvgMoviedb = (props) => (
  <svg
    id="moviedb_svg__Layer_1"
    data-name="Layer 1"
    viewBox="0 0 407.34 160.81"
    {...props}
  >
    <defs>
      <style>{".moviedb_svg__cls-1{fill:#01d277}"}</style>
    </defs>
    <path
      className="moviedb_svg__cls-1"
    ...
    <path
      className="moviedb_svg__cls-1"
      d="M3472.7 1860.23c2.18-1.5 3.11-4.22 3.2-6.84.15-6.12-3.69-10.53-9.85-10.53h-13.74v34.75H3466a10.32 10.32 0 0 0 10.24-10.44 8.43 8.43 0 0 0-3.54-6.94zm-13.4-10.44h6.17a3.51 3.51 0 0 1 0 7h-6.17v-7zm6.17 20.87h-6.17v-6.94h6.17a3.41 3.41 0 0 1 3.49 3.45 3.45 3.45 0 0 1-3.49 3.5z"
      transform="translate(-3111.93 -1774.68)"
    />
    <path
      className="moviedb_svg__cls-1"
